...
(()=>{
 ...
 .mv-days-grid{display:grid;grid-template-columns:1fr 1fr;margin-top:4px}.mv-day-info{padding:3px 10px 1px 0;min-width:0}.mv-day-info+.mv-day-info{border-top:0;border-left:1px solid rgba(0,0,0,.72);padding-left:10px;padding-right:0}.mv-day-label{font-size:.66rem;font-weight:800;opacity:.82;margin:0 0 3px}.mv-day-tomorrow>.mv-day-label{text-align:right}
 .mv-info{display:grid;grid-template-columns:28px minmax(0,1fr) auto;column-gap:4px;align-items:start;padding:3px 0}.mv-info-icon{font-size:.74rem;line-height:1.22;width:28px;text-align:left}.mv-info-text{min-width:0}.mv-info-text strong{display:block;font-size:.74rem;line-height:1.22}.mv-info-text small{display:block;font-size:.66rem;line-height:1.2;opacity:.8}.mv-idea{appearance:none;border:0;background:transparent;color:inherit;padding:0 0 0 10px;font:inherit;font-size:.68rem;font-weight:800;line-height:1.22;cursor:pointer;text-decoration:underline;text-underline-offset:2px;white-space:nowrap}
 .mv-tourism{border-bottom:1px solid rgba(0,0,0,.72);margin:0;padding:2px 0 6px;display:grid;grid-template-columns:auto 1fr auto;align-items:center;gap:10px}.mv-tourism span{text-align:center;font-size:.74rem;font-weight:800}.mv-tourism button{appearance:none;border:1px solid rgba(7,60,74,.32);border-radius:999px;background:rgba(255,255,255,.22);color:inherit;padding:4px 10px;font:inherit;font-size:.70rem;font-weight:800;cursor:pointer}.mv-tourism button:active{transform:scale(.97)}
 ...
 #todayEmpty,#tomorrowEmpty{display:none!important}
 ...
 body.mv-density-compact .mv-day-info,body.mv-density-tight .mv-day-info{padding-top:1px;padding-bottom:1px}body.mv-density-compact .mv-tourism,body.mv-density-tight .mv-tourism{padding-bottom:4px}
